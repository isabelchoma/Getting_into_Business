...
#Example of how to do a scatterplot
plot(housing_data$bedrooms, housing_data$bathrooms, pch=19)

#Example of how to do a boxplot
boxplot(housing_data$bedrooms)

#Example of how to do a histogram 
